...
<div id="dashboard-adm" class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center m-lg-3 justify-content-between mb-4">
        <h1 class="h3 title mb-0">Tambahkan Portofolio Baru</h1>
    </div>
                ...
                @endif
                    ...
                    <form action="{{ route('portfolios.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_klient" class="form-control" id="nama_klient" aria-describedby="nama_klient">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_project" class="form-label">Tanggal Project</label>
                            <input type="date" name="tanggal_project" class="form-control" id="tanggal_project" aria-describedby="tanggal_project">
                        </div>
                        <div class="mb-3">
